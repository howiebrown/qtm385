...
:::{style="margin-top: 30px; font-size: 26px;"}
- While it is common to add covariates to the model, [Freedman (2008)](https://doi.org/10.1214/07-AOAS143) demonstrated that pre-treatment covariate adjustment may bias estimates of average treatment effects in small samples
...
- [Lin (2013)](https://doi.org/10.1214/12-AOAS583) came up with a solution that involves a series of data transformations to make the covariates orthogonal to the treatment variable
- He also argues that this bias is pretty much negligible in large samples
