...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Survey](https://raw.githack.com/danilofreire/qtm385/main/lectures/lecture-21/21-survey.html)"
transition: slide
...
of London is more or less than
...
Think about whether the population
of London is more or less than
20,000,000 people. What do you think
the population of London is?
:::
...
:::{.columns}
:::{.column width="50%"}
- [Population of London]{.alert}: 9.4 million
...
- Example: 
  ...
  - Non-equivalent outcome: attitudes toward group 
:::
:::
:::
